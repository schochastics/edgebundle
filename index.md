...
![](reference/figures/README-plot-2.png)

For
[`edge_bundle_stub()`](https://schochastics.github.io/edgebundle/reference/edge_bundle_stub.md),
you need `geom_bezier()` from the package {{ggforce}}.
...
![](reference/figures/README-bezier-1.png)
...
![](reference/figures/flights_fdeb.png)![](reference/figures/flights_heb.png)![](reference/figures/flights_seb.png)![](reference/figures/flights_peb.png)
...
an angle-restricted spiral tree: it is planar, keeps node positions
fixed, needs no dummy nodes, and is controlled by a single angle
parameter.
...
![](reference/figures/cali2010_flow.png)

To smooth the tree, use
[`tnss_smooth()`](https://schochastics.github.io/edgebundle/reference/tnss_smooth.md).
Note that this changes the object type and you need to visualize it with
{{ggplot2}} rather than {{ggraph}}.
...
![](reference/figures/cali2010_flow_smoothed.png)
...
`graphlayouts::layout_as_metromap()` instead.
...
![](reference/figures/metro_berlin.png)
